...
print('<div class="row">');   //row 4
    ...
    print('</div>');
	print('<div class="column three-quarters">');
...
print('<div class="row">');   // row 7
	...
	print('</div>');
	print('<div class="column three-quarters">');
    print('<input type="text" name="email" id="email" onfocus="toDefault(this);" class="txt" placeholder="Email" value="'.$email.'" required >');
	print('</div>');
print('</div>');    // row 7
...
<div class="row">  <!-- row 8 -->
    ...
    <div class="column three-quarters">
        <div><input type="text" name="password1" id="password1" onfocus="toDefault(this, 'strength_box1');" class="txt" placeholder="Password" value="<?php echo $password1; ?>" required ></div>
...
<div class="row">  <!-- row 9 -->
	...
	<div class="column three-quarters">   <!-- row 3/4 -->
        <div><input type="text" name="password2" id="password2" onfocus="toDefault(this, 'strength_box2');" class="txt"  placeholder="Confirm password" value="<?php echo $password2; ?>" required ></div>
...
<div class="column half"> <!--1/2-->
    <div class="row">               <!--row inside half-->
        <div class="column one-quarter"></div>
        <div class="column half" onclick="toDefault(this);"  id="beast">
            <div class="column one-third tooltip"><span class="tooltiptext">Lion</span><img src="resources/img/lionccdark.jpg" style="width:50px;" class="captcha-img" alt="" /><input type="radio" name="choice" id="lion" value="lion" class="animal"/></div>
            <div class="column one-third tooltip"><img src="resources/img/coyoteccdark.jpg" style="width:50px" alt="" class="captcha-img"/><span class="tooltiptext">Coyote</span><input type="radio" name="choice" id="coyote" value="coyote" class="animal"/></div>
            <div class="column one-third tooltip"><img src="resources/img/bearccdark.jpg" style="width:50px" alt="" class="captcha-img"/><span class="tooltiptext">Bear</span><input type="radio" name="choice" value="bear" id="bear" class="animal"/></div>
        </div>
        <div class="column one-quarter"></div>
    </div> <!--row inside half-->
</div> <!--1/2-->

<div class="column one-quarter"><input type="hidden" name="animal" id="animal" /><input type="hidden" name="selected" id="selected" /></div>
</div>  <!--row 12-->

<div class="row">   <!--row 13-->
<div class="column one-quarter">&nbsp;</div>  <!--1/4 row 13-->
<div class="column three-quarters">  <!--3/4 row 13-->
